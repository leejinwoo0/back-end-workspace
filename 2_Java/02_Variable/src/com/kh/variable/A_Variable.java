...
//		syso(ctrl + space바 누르면 자동완성) (10 * 2 * 3.141592);
		...
		System.out.println(r * r * pi);// syso 입력후 ctrl + 스페이스바 -> 엔터키
	}
	...
	public void variableTest(){
		...
		*/
		...
		// 2. 문자형 : 2byte(=16bit)
		char ch = 'a';
//		          ch = 'ab'; 에러발생 --> 주석 단축키 : ctrl + /

		// 3. 정수형
		byte bNUM = 1; // 1byte(= 8bit)(-128~127) 256 = 2^8
//		bNUM = 128; 주석처리 (에러발생) -> 오버플로우(Overflow)
...
//		int class;
		...
		int MaxNumber; // 클래스랑 구분짓기 위해서 첫글자는 대문자로 잘안쓰임
		int maxNumber; // 자바에서!
	...
	public void constant() {
		 ...
		 * - 상수의 네이밍 규칙은 대문자로 표기, 여러 단어가 오면_ 로 구분
		 * */
		int age = 20;
		age = 25;
